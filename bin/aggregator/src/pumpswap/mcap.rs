...
use crate::config::PumpswapMcapConfig;
...
#[async_trait]
impl Worker<Partition> for McapWorker {
...
pub fn pumpswap_mcap(cfg: PumpswapMcapConfig, signal: Signal) -> JoinHandle<()> {
    spawn(async move {
